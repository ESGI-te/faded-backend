...
class ServiceFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private array $hair_services =
        array(array('name' => 'Coupe Ciseaux & Coiffage','price' => 35.00,'duration' => 60),
    ...
    private array $beard_services =
        array(array('name' => 'Coupe & barbe','price' => 35.00,'duration' => 60),
    ...
    private array $color_services =
        array(array('name' => 'Decoloration + Coloration - court','price' => 75.00,'duration' => 120),
    ...
    private array $face_services =
        array(array('name' => 'Soin de visage classique','price' => 30.00,'duration' => 30),
    ...
    private array $permanent_services =
        array(array('name' => 'Permanante (curly) - court','price' => 60.00,'duration' => 90),
    ...
    public function load(ObjectManager $manager) : void
    {
        ...
        for ($i=0 ; $i< sizeof($this->hair_services) ; $i++ ){
            ...
            $establishement1 = $this->getReference(EstablishementFixtures::ESTABLISHEMENT_REFERENCE.'-0');
            $establishement = $this->getReference(EstablishementFixtures::ESTABLISHEMENT_REFERENCE.'-9');
            $service->addEstablishment($establishement1);
            $service->addEstablishment($establishement);
        ...
        for ($i=0 ; $i< sizeof($this->beard_services) ; $i++ ){
            ...
            $establishement1 = $this->getReference(EstablishementFixtures::ESTABLISHEMENT_REFERENCE.'-1');
            $establishement = $this->getReference(EstablishementFixtures::ESTABLISHEMENT_REFERENCE.'-8');
            $service->addEstablishment($establishement1);
            $service->addEstablishment($establishement);
        ...
        for ($i=0 ; $i< sizeof($this->color_services) ; $i++ ){
            ...
            $establishement1 = $this->getReference(EstablishementFixtures::ESTABLISHEMENT_REFERENCE.'-3');
            $establishement = $this->getReference(EstablishementFixtures::ESTABLISHEMENT_REFERENCE.'-7');
            $service->addEstablishment($establishement1);
            $service->addEstablishment($establishement);
        ...
        for ($i=0 ; $i< sizeof($this->face_services) ; $i++ ){
            ...
            $establishement1 = $this->getReference(EstablishementFixtures::ESTABLISHEMENT_REFERENCE.'-4');
            $establishement = $this->getReference(EstablishementFixtures::ESTABLISHEMENT_REFERENCE.'-6');
            $service->addEstablishment($establishement1);
            $service->addEstablishment($establishement);
        ...
        for ($i=0 ; $i< sizeof($this->permanent_services) ; $i++ ){
            ...
            $establishement = $this->getReference(EstablishementFixtures::ESTABLISHEMENT_REFERENCE.'-5');
            $service->addEstablishment($establishement);
    ...
    {
        return [ServiceCategoryFixtures::class,EstablishementFixtures::class];
    }
}